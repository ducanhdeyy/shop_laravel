...
@section('content')
    ...
    <div class="col-lg-5">
        <div class="position-relative row form-group">
            ...
            <div class="col-md-9 col-xl-8">
                <input required="" name="name" id="name" placeholder="Name" type="text" class="form-control" value="{{old('name')}}">
            </div>
        </div>
        <div class="position-relative row form-group">
        ...
        <div class="position-relative row form-group">
            ...
            <div class="col-md-9 col-xl-8">
                <input name="amount" id="amount" placeholder="amount"
                       type="text" class="form-control" value="{{old('amount')}}">
            </div>
        </div>
        ...
        <div class="position-relative row form-group">
            <label for="sizes" class="col-md-3 text-md-right col-form-label">Size</label>
            <div class="col-md-9 col-xl-8">
