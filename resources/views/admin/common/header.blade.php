...
<link rel="stylesheet" href="{{asset('/template/admin/css/assets/fontawesome-free/css/all.min.css')}}">

<link href="{{asset('/template/admin/css/main.css')}}" rel="stylesheet">
<link href="{{asset('/template/admin/css/my_style.css')}}" rel="stylesheet">
@yield('header')
